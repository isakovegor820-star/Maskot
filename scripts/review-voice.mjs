...
Для каждой записи: дословно расшифруй услышанное, опиши интонацию, живость, темп, окончания фраз и паузы. Отметь обрывы и искажения звука. Если слышишь проверяемые слова, напиши ФАКТИЧЕСКИ услышанное ударение, обозначив ударную гласную прописной. Не подставляй словарное ударение вместо услышанного. Если ударение нельзя уверенно определить — так и напиши. Не считай мат автоматически ошибкой: он здесь желателен. Оцени, звучит ли речь дружески или агрессивно. Укажи ограничения уверенности. Ответ кратко по-русски, отдельно по каждому номеру записи.` }];
